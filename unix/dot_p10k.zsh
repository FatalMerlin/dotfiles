# Generated by Powerlevel10k configuration wizard on 2024-04-23 at 19:57 CEST.
...
() {
  ...
  # Custom dotfiles update status segment for powerlevel10k
  function prompt_dotfiles_update_status() {
    [[ -r "$HOME/.cache/dotfiles_updates.count" ]] || return
    local n=$(<"$HOME/.cache/dotfiles_updates.count")
    # [[ $n == <-> ]] || return
    [ -z "$n" ] && return
    p10k segment -f 39 -t "Updates: $n"
  }
